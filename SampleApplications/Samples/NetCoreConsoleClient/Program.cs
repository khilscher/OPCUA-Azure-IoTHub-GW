...
namespace NetCoreConsoleClient
{
    public class Program
    {
        ...
        public static async Task ConsoleSampleClient(string endpointURL)
        {
            ...
            Console.WriteLine("0 - Connecting to Azure IoT Hub");
            ...
            var list = new List<MonitoredItem> {
                new MonitoredItem(subscription.DefaultItem)
                {
                    ...
                    DisplayName = "Counter1", StartNodeId = "ns=5;s=Counter1"
                },
                new MonitoredItem(subscription.DefaultItem)
                {
                    DisplayName = "Sawtooth1", StartNodeId = "ns=5;s=Sawtooth1"
                }
            };
        ...
        private static async void SendD2CMessageAsync(dynamic telemetry)
        { 

            var messagePayloadInJson = JsonConvert.SerializeObject(telemetry);

            var encodedMessage = new Message(System.Text.Encoding.ASCII.GetBytes(messagePayloadInJson));
